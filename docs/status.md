...
| Full-output FIR | Executable valid-mode Q15/Q31/f32 architecture prototypes plus a zero-padded full-boundary Q15 scalar spike; no stable full-output operation yet |
