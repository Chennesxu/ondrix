...
| Full-output FIR | Executable valid-mode architecture prototype built from an outer SCF output loop and the existing single-sample FIR contract; no stable full-output operation yet |
