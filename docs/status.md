...
| Full-output FIR | Experimental tensor-only destination-style `ondrix.fir_filter` for valid boundaries with Q15/Q31/f32 AOT execution; memref/alias, padded boundaries, tiling, and streaming remain open |
