...
public:
  ...
  void runOnOperation() override {
    ...
    // The packed complex filter and the Viterbi decoder have no scalar tensor
    // form: both walk buffers, so bufferization is their only lowering and
    // this pass leaves them alone whatever the option below says.
    target.addLegalOp<ondrix::ir::CxFirFilterOp, ondrix::ir::ViterbiDecodeOp>();
