...
// RUN: ondrix-compile %S/../Frontend/Inputs/q15_dot.ox --checked-entries --emit=llvm | FileCheck %s --check-prefix=CHECKED
// RUN: ondrix-compile %S/../Frontend/Inputs/q15_dot.ox --checked-entries --emit=manifest | FileCheck %s --check-prefix=MANIFEST
...
// The driver flag reaches the emit pass and the manifest records it.
// CHECKED-LABEL: llvm.func @ondrix_q15_dot(
// CHECKED: llvm.intr.umax
// CHECKED: llvm.call @q15_dot(
// MANIFEST: emit-ondrix-c-entry-points{checked=true}
