...
// and the result is the caller's buffer, so no storage of any kind remains.
// At 256 the batcher consumes the copy.
// ORDERED-LABEL: llvm.func @matmul4x16x3_q31
// ORDERED-NOT: llvm.alloca
// ORDERED-NOT: llvm.call @malloc
// ORDERED-NOT: llvm.call @free
// BATCHED-LABEL: llvm.func @matmul4x16x3_q31
// BATCHED-NOT: llvm.alloca
