...
// RUN: ondrix-opt %t.bufferized.mlir --pass-pipeline='builtin.module(vectorize-ondsp-fp-filter-outputs{vector-width=8},vectorize-ondsp-fp-fast-memref-reduce{vector-width=8},vectorize-ondsp-fixed-decimate-outputs{vector-width=8},vectorize-ondsp-constant-saturating-memref-reduce{vector-width=8 max-elements=64},vectorize-ondsp-fixed-memref-reduce{vector-width=8},parallelize-ondsp-fixed-wrap-vector-reduce,normalize-ondsp-fixed-vector-reduce)' > %t.once.mlir
// RUN: ondrix-opt %t.once.mlir --pass-pipeline='builtin.module(vectorize-ondsp-fp-filter-outputs{vector-width=8},vectorize-ondsp-fp-fast-memref-reduce{vector-width=8},vectorize-ondsp-fixed-decimate-outputs{vector-width=8},vectorize-ondsp-constant-saturating-memref-reduce{vector-width=8 max-elements=64},vectorize-ondsp-fixed-memref-reduce{vector-width=8},parallelize-ondsp-fixed-wrap-vector-reduce,normalize-ondsp-fixed-vector-reduce)' > %t.twice.mlir
