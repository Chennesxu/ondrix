...
func.func @q15_high_product_is_not_a_full_product_target(
  ...
  %0 = ondsp.mac %acc, %a, %b {numeric = #ondsp.fixed<signed, storage = i16, frac = 15>, product = #ondsp.product<high>} : (!ondsp.acc<storage = i40, frac = 14, signed, update_overflow = saturate>, i16, i16) -> !ondsp.acc<storage = i40, frac = 14, signed, update_overflow = saturate>
