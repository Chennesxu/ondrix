...
func.func @vector_butterfly_requires_vector_lowering(
  ...
  // CHECK: ortumcore butterfly lowering requires signless scalar packed i32 operands
...
func.func @vector_butterfly_results_require_vector_lowering(
  ...
  // CHECK: ortumcore butterfly lowering requires signless scalar packed i32 results
