...
func.func @dot_quantize(%lhs: i16, %rhs: i16, %wide: i32) -> (i16, i16) {
  ...
  %2 = ondrix.quantize %wide {src = #ondsp.fixed<signed, storage = i32, frac = 31>, dst = #ondsp.fixed<signed, storage = i16, frac = 15>, rounding = #ondsp.rounding<nearest_even>, overflow = #ondsp.overflow<saturate>, tag = "quantize"} : (i32) -> i16
  return %1, %2 : i16, i16
}
...
// CHECK: ondsp.round_shift %arg2 {scale = #ondsp.scale<pre_shift_left = 0, post_shift_right = 16, rounding = nearest_even, overflow = saturate, saturate_to = i16>} : (i32) -> i16
