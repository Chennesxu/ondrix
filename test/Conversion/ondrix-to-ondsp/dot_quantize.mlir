...
func.func @dot_quantize(%lhs: i16, %rhs: i16) -> i16 {
  %0 = ondrix.dot %lhs, %rhs {numeric = #ondsp.fixed<signed, storage = i16, frac = 15>, tag = "dot"} : (i16, i16) -> i32
...
// CHECK-NOT: ondrix.
// CHECK: ondsp.reduce_mac %arg0, %arg1 {numeric = #ondsp.fixed<signed, storage = i16, frac = 15>, tag = "dot"} : (i16, i16) -> i32
