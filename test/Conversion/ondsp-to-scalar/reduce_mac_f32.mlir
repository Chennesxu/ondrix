...
func.func @reduce_mac_fma(%lhs: memref<8xf32>, %rhs: memref<8xf32>, %seed: f32) -> f32 {
  ...
  %0 = ondsp.reduce_mac %lhs, %rhs {numeric = #ondsp.fp<format = f32, contract = fma>} : (memref<8xf32>, memref<8xf32>) -> f32
  return %0 : f32
}
...
func.func @reduce_mac_off(%lhs: memref<8xf32>, %rhs: memref<8xf32>) -> f32 {
  %0 = ondsp.reduce_mac %lhs, %rhs {numeric = #ondsp.fp<format = f32, contract = off>} : (memref<8xf32>, memref<8xf32>) -> f32
  return %0 : f32
}
...
func.func @reduce_mac_fast(%lhs: memref<8xf32>, %rhs: memref<8xf32>) -> f32 {
  %0 = ondsp.reduce_mac %lhs, %rhs {numeric = #ondsp.fp<format = f32, contract = fast>} : (memref<8xf32>, memref<8xf32>) -> f32
  return %0 : f32
}
