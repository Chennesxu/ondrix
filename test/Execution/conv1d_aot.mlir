...
// RUN: cc %S/Inputs/conv1d_aot.c %t.o -lm -o %t
// RUN: %t
...
// RUN: cc %S/Inputs/conv1d_aot.c %t.bufferized.o -lm -o %t.bufferized
// RUN: %t.bufferized
...
// RUN: cc %S/Inputs/conv1d_aot.c %t.vector.o -lm -o %t.vector
// RUN: %t.vector
