// RUN: ondrix-compile %S/../Frontend/Inputs/q31_fir_constexpr.ox > %t.source.mlir
...
// RUN: cc %S/Inputs/ox_q31_constexpr_fir_aot.c %t.o -o %t
// RUN: %t

// LOWERED-NOT: ondrix.
// LOWERED-NOT: ondsp.
// LOWERED: llvm.func @q31_fir_constexpr
