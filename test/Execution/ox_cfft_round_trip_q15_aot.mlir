// RUN: ondrix-compile %S/../Frontend/Inputs/q15_cfft_round_trip.ox > %t.source.mlir
...
// RUN: cc %S/Inputs/ox_cfft_round_trip_q15_aot.c %t.o -o %t
// RUN: %t

// CHECK-NOT: ondrix.
// CHECK-NOT: ondsp.
// CHECK: llvm.func @_mlir_ciface_q15_cfft_round_trip
