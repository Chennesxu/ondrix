...
// RUN: cc -DFIR_DECIMATE_SYMBOL=_mlir_ciface_q15_fir_decimate -DFIR_DECIMATE_ACCUMULATOR_WIDTH=34 -DFIR_DECIMATE_UPDATE_OVERFLOW=WRAP %S/Inputs/fir_decimate_q15_aot.c %t.scalar.o -o %t.scalar
// RUN: %t.scalar
...
// RUN: cc -DFIR_DECIMATE_SYMBOL=_mlir_ciface_q15_fir_decimate -DFIR_DECIMATE_ACCUMULATOR_WIDTH=34 -DFIR_DECIMATE_UPDATE_OVERFLOW=WRAP %S/Inputs/fir_decimate_q15_aot.c %t.vector.o -o %t.vector
// RUN: %t.vector
