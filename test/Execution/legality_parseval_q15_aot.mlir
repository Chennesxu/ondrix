...
// input: six rounding boundaries per bin replace the exact isometry. The
// spectral side compiles through the full contract; the exact time-domain
// energy is integer arithmetic with no quantization at all.
