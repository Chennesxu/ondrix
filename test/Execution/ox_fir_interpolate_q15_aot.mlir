...
// RUN: cc -DFIR_INTERPOLATE_SYMBOL=_mlir_ciface_q15_fir_interpolate -DFIR_INTERPOLATE_ACCUMULATOR_WIDTH=33 -DFIR_INTERPOLATE_UPDATE_OVERFLOW=WRAP %S/Inputs/fir_interpolate_q15_aot.c %t.o -o %t
// RUN: %t
...
// SOURCE-SAME: rounding = #ondsp.rounding<nearest_even>
