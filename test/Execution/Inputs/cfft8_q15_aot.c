...
extern int32_t cfft8_q15_value(int32_t x0, int32_t x1, int32_t x2, int32_t x3, int32_t x4,
...
int main(void) {
  ...
  for (unsigned caseIndex = 0; caseIndex < sizeof(cases) / sizeof(cases[0]); ++caseIndex) {
    ...
    for (unsigned i = 0; i < 8; ++i) {
      int32_t actual = cfft8_q15_value(input[0], input[1], input[2], input[3], input[4], input[5],
