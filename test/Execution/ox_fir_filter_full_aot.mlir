// RUN: ondrix-compile %S/../Frontend/Inputs/q15_fir_filter_full.ox > %t.q15.source.mlir
...
// RUN: ondrix-compile %S/../Frontend/Inputs/q31_fir_filter_full.ox > %t.q31.source.mlir
...
// RUN: ondrix-compile %S/../Frontend/Inputs/f32_fir_filter_full.ox > %t.f32.source.mlir
...
// RUN: cc -ffp-contract=off %S/Inputs/ox_fir_filter_full_aot.c %t.q15.o %t.q31.o %t.f32.o -lm -o %t
// RUN: %t
