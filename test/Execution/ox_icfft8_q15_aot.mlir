// RUN: ondrix-compile %S/../Frontend/Inputs/q15_icfft8.ox > %t.source.mlir
...
// RUN: cc %S/Inputs/ox_icfft8_q15_aot.c %t.o -o %t
// RUN: %t
...
// RUN: cc %S/Inputs/ox_icfft8_q15_aot.c %t.vector.o -o %t.vector
// RUN: %t.vector

// CHECK-NOT: ondrix.
// CHECK-NOT: ondsp.
// CHECK: llvm.func @_mlir_ciface_q15_icfft8
