// RUN: ondrix-compile %S/../Frontend/Inputs/q31_fir_stream.ox > %t.source.mlir
...
// RUN: cc %S/Inputs/ox_q31_fir_stream_aot.c %t.o -o %t
// RUN: %t

// SOURCE-LABEL: func.func @q31_fir_stream
// SOURCE: ondrix.fir_stream
// SOURCE-SAME: !ondsp.acc<storage = i64, frac = 62, signed, update_overflow = saturate>

// LOWERED-LABEL: llvm.func @q31_fir_stream
// LOWERED-NOT: ondrix.
// LOWERED-NOT: ondsp.
// LOWERED-NOT: tensor.
