// RUN: ondrix-compile %S/../Frontend/Inputs/q31_sos_df2_fixed.ox > %t.source.mlir
...
// RUN: cc %S/Inputs/ox_q31_sos_df2_fixed_aot.c %t.o -o %t
// RUN: %t

// SOURCE-LABEL: func.func @q31_sos_df2_fixed
// SOURCE: ondrix.sos_filter_df2_fixed
// SOURCE-SAME: !ondsp.acc<storage = i64, frac = 62, signed, update_overflow = saturate>

// LOWERED-LABEL: llvm.func @q31_sos_df2_fixed
// LOWERED-NOT: ondrix.
// LOWERED-NOT: ondsp.
// LOWERED-NOT: tensor.
