...
func.func @ondsp_ops(%a: i16, %b: i16, %p0: i32, %p1: i32, %tw: i32,
  ...
  %o0, %o1 = ondsp.cx_butterfly %p0, %p1, %tw {layout = #ondsp.cx_layout<packed_i16_imag_hi_real_lo>, numeric = #ondsp.fixed<signed, storage = i16, frac = 15>} : (i32, i32, i32) -> (i32, i32)
