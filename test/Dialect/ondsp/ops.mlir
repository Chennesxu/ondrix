...
func.func @ondsp_ops(%a: i16, %b: i16, %v0: vector<4xi16>, %v1: vector<4xi16>,
    ...
    -> (i32, !ondsp.acc<storage = i40, frac = 30, signed, update_overflow = saturate>, i32, index) {
  ...
  return %out, %red, %o0, %j : i32, !ondsp.acc<storage = i40, frac = 30, signed, update_overflow = saturate>, i32, index
}
