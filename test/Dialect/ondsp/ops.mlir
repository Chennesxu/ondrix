...
func.func @ondsp_ops(%a: i16, %b: i16, %v0: vector<4xi16>, %v1: vector<4xi16>,
  ...
  %updated = ondsp.acc_add_term %mac, %product {term_numeric = #ondsp.fixed<signed, storage = i32, frac = 30>} : (!ondsp.acc<storage = i40, frac = 30, signed, update_overflow = saturate>, i32) -> !ondsp.acc<storage = i40, frac = 30, signed, update_overflow = saturate>
