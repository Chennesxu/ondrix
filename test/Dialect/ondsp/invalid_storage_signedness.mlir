...
func.func @accumulator_storage_must_be_signless(%input: i16)
    -> !ondsp.acc<storage = ui40, frac = 30, unsigned> {
  %0 = ondsp.acc_init %input : (i16) -> !ondsp.acc<storage = ui40, frac = 30, unsigned>
  return %0 : !ondsp.acc<storage = ui40, frac = 30, unsigned>
}
